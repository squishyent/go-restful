...
func main() {
	print("Start:  http://localhost:8080/profiler/start\n")
	print("Stop:  http://localhost:8080/profiler/stop\n")
	NewProfileService("/profiler", "sample.prof").AddWebServiceTo(restful.DefaultContainer)
